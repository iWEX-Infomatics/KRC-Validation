frappe.ui.form.on('Contact', {
    ...
    designation: frm => handle_name_field(frm, 'designation'),
    ...
    before_save(frm) {
        ...
        ['first_name', 'middle_name', 'last_name', 'designation'].forEach(f => {
...
function get_text_fields(frm) {
    ...
    return frm.meta.fields.filter(
        f => TEXT_TYPES.includes(f.fieldtype)
    );
